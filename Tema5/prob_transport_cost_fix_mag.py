...
class transport_min_pe_mat:
    def __init__(self, d, r, SCj, Dk, costuri, costuri_fixe_mag):
        self.d = d
        self.r = r
        self.SCj = SCj
        self.Dk = Dk
    ...
    def calculeaza_cost(self, dep_i, mag_i):
        ...
        cost = min(self.SCj[dep_i], self.Dk[mag_i]) * self.costuri[dep_i][mag_i] + self.costuri_fixe_mag[dep_i][mag_i]
...
if __name__ == '__main__': 
    ...
    for key, item in data.items():
        ...
        start = time.time()
        alg = transport_min_pe_mat(item['d'], item['r'], item['SCj'], item['Dk'], item['costuri'], item['costuri_fixe_mag'])
    ...
    date_optime = [11279, 7250, 5941, 42691, 44075, 39042, 112476, 121731, 133285]
