...
class transport_min_pe_mat:
    def __init__(self, d, r, SCj, costuri_fixe_dep, Dk, costuri):
        self.d = d
        self.r = r
        self.SCj = SCj
        self.Dk = Dk
    ...
    def calculeaza_cost(self, dep_i, mag_i):
        ...
        cost = min(self.SCj[dep_i], self.Dk[mag_i]) * self.costuri[dep_i][mag_i] + self.costuri_fixe_dep[dep_i]
...
if __name__ == '__main__': 
    ...
    for key, item in data.items():
        ...
        start = time.time()
        alg = transport_min_pe_mat(item['d'], item['r'], item['SCj'], item['costuri_fixe_dep'], item['Dk'], item['costuri'])
    ...
    date_optime = [13492, 8789, 8433, 43492, 50264, 37857, 108135, 126060, 122954]
